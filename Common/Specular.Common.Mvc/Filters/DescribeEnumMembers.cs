...
namespace NgSoftware.Specular.Common.Mvc.Filters;
...
public class DescribeEnumMembers : ISchemaFilter
{
    ...
    public DescribeEnumMembers(XDocument xmlComments)
    {
        ...
        assemblyName = DetermineAssembly(xmlComments);
    }

    /// <summary>
    /// Pre-amble to use before the enum items
    /// </summary>
    public static string Prefix { get; set; } = "<p>Возможные значения:</p>";
    ...
    private static string DetermineAssembly(XDocument doc)
    {
